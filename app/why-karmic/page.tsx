...
export const metadata: Metadata = {
  title: "Why Choose Karmic Konnexions",
  description: "60% cost savings, 3-4x ROI and zero compliance liability — discover why 500+ companies choose us.",
};
...
export default function WhyKarmicPage() {
  return (
    <>
      <PageHero
        title="Why Choose Karmic Konnexions"
        subtitle="60% cost savings, 3-4x ROI and zero compliance liability — discover why 500+ companies choose us."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Why Karmic', href: '/why-karmic' }]}
      />
