...
export const metadata: Metadata = {
  ...
  description: "Trusted across 20+ industries including logistics, manufacturing, healthcare, fintech and more.",
};
...
export default function IndustriesPage() {
  return (
    <>
      <PageHero
        title="Industries We Serve"
        subtitle="Trusted across 20+ industries including logistics, manufacturing, healthcare, fintech and more."
