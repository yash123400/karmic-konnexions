...
export const metadata: Metadata = {
  title: "Initiatives",
  description: "Social impact and rural entrepreneurship initiatives by Karmic Konnexions.",
};
...
export default function InitiativesPage() {
  return (
    <>
      <PageHero
        title="Initiatives"
        subtitle="Social impact and rural entrepreneurship initiatives by Karmic Konnexions."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Initiatives', href: '/initiatives' }]}
      />
