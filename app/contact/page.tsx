...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Karmic Konnexions Global Consulting LLP, Gurgaon.",
};
...
export default function ContactPage() {
  return (
    <>
      <PageHero
        title="Contact Us"
        subtitle="Get in touch with Karmic Konnexions Global Consulting LLP, Gurgaon."
