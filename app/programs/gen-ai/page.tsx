...
export const metadata: Metadata = {
  ...
  description: "Enterprise generative AI training and implementation programs.",
};
...
export default function GenAIPage() {
  return (
    <>
      <PageHero
        title="Generative AI Suites"
        subtitle="Enterprise generative AI training and implementation programs."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Programs', href: '/programs' }, { label: 'Gen Ai', href: '/programs/gen-ai' }]}
      />
