...
export const metadata: Metadata = {
  title: "Business-Stack Leadership Program",
  description: "Executive leadership development program for modern business leaders.",
};
...
export default function BusinessStackPage() {
  return (
    <>
      <PageHero
        title="Business-Stack Leadership Program"
        subtitle="Executive leadership development program for modern business leaders."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Programs', href: '/programs' }, { label: 'Business Stack', href: '/programs/business-stack' }]}
      />
