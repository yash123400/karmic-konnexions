...
export const metadata: Metadata = {
  title: "Data Zenmaster & Analytics",
  description: "Data analytics and business intelligence training program.",
};
...
export default function DataZenmasterPage() {
  return (
    <>
      <PageHero
        title="Data Zenmaster & Analytics"
        subtitle="Data analytics and business intelligence training program."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Programs', href: '/programs' }, { label: 'Data Zenmaster', href: '/programs/data-zenmaster' }]}
      />
