...
export const metadata: Metadata = {
  title: "Case Studies",
  description: "Real-world results from our outsourcing, e-learning and workforce solutions.",
};
...
export default function CaseStudiesPage() {
  return (
    <>
      <PageHero
        title="Case Studies"
        subtitle="Real-world results from our outsourcing, e-learning and workforce solutions."
