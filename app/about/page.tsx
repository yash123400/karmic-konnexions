...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about Karmic Konnexions Global Consulting LLP — a multi-vertical B2B services company based in Gurgaon with global operations.",
};
...
export default function AboutPage() {
  return (
    <>
      <PageHero
        title="About Us"
        subtitle="Learn about Karmic Konnexions Global Consulting LLP — a multi-vertical B2B services company based in Gurgaon with global operations."
