...
export const metadata: Metadata = {
  title: "Our Services",
  description: "Full-spectrum outsourcing, e-learning, workforce and AI automation services for enterprises worldwide.",
};
...
export default function ServicesPage() {
  return (
    <>
      <PageHero
        title="Our Services"
        subtitle="Full-spectrum outsourcing, e-learning, workforce and AI automation services for enterprises worldwide."
