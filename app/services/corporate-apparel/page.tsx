...
export const metadata: Metadata = {
  ...
  description: "Branded uniform and corporate attire solutions for enterprise clients.",
};
...
export default function CorporateApparelPage() {
  return (
    <>
      <PageHero
        title="Corporate Apparel Solutions"
        subtitle="Branded uniform and corporate attire solutions for enterprise clients."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Corporate Apparel', href: '/services/corporate-apparel' }]}
      />
