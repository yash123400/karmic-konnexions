...
export const metadata: Metadata = {
  title: "HRO Outsourcing — Human Resources Operations | Karmic Konnexions",
  description:
    "Karmic Konnexions delivers HRO — Human Resources Operations outsourcing and allied functions including Accounts, Marketing, and CRM, powered by Agentic AI.",
  keywords: [
    "HRO outsourcing India",
    "HR operations outsourcing Gurgaon",
    "HR outsourcing",
    "finance outsourcing",
    "CRM outsourcing",
  ],
...
const bpoFaqs = [
  ...
  { q: "How do you ensure data security?", a: "All our HRO operations follow ISO 27001 guidelines. Data is accessed through secured VPN channels, with role-based access controls and NDA-bound contracts for every engagement." },
            ...
            <div className="flex-1">
              ...
              <RevealSection delay={0.35}>
                <p className="text-lg md:text-xl text-[#374151] mt-6 max-w-2xl leading-relaxed">
                  Karmic Konnexions delivers end-to-end HRO solutions that cut
                  operational costs by up to 60% while elevating service quality.
                  Our HRO solutions are enhanced by Agentic AI — intelligent digital
                  systems that automate workflows, surface insights, and reduce manual
                  overhead across HR, Finance, CRM, and Marketing functions.
                </p>
              </RevealSection>
