...
export const metadata: Metadata = {
  ...
  description: "Talent acquisition, contract staffing and RPO across India, SEA, Middle East, Africa and Europe.",
};
...
export default function GlobalWorkforcePage() {
  return (
    <>
      <PageHero
        title="Global Workforce Solutions"
        subtitle="Talent acquisition, contract staffing and RPO across India, SEA, Middle East, Africa and Europe."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Global Workforce', href: '/services/global-workforce' }]}
      />
