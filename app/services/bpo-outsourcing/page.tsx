...
export const metadata: Metadata = {
  ...
  description: "Fixed-cost, execution-focused outsourcing for HR, Finance, CRM and Marketing functions.",
};
...
export default function BPOOutsourcingPage() {
  return (
    <>
      <PageHero
        title="BPO Outsourcing Services"
        subtitle="Fixed-cost, execution-focused outsourcing for HR, Finance, CRM and Marketing functions."
        breadcrumb={[{ label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Bpo Outsourcing', href: '/services/bpo-outsourcing' }]}
      />
